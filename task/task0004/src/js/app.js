...
window.onload = function() {
    var model = new Model([new Catergory('tt'), new Catergory('bb')]),
        view = new View(model, {
            ...
            'taskEditedConfirmBtn': $('#task_edited_confirm_btn'),
            'taskEditedCancelBtn': $('#task_edited_cancel_btn'),
            'taskTitle': $('#task_title'),
            'taskDate': $('#task_date'),
            'taskContent': $('#task_content'),
            'taskEditTool': $('#task_edit_tool'),
            'taskAddTool': $('#task_add_tool'),
            'taskAddConfirmBtn': $('#task_add_confirm_btn'),
            'taskAddCancelBtn': $('#task_add_cancel_btn'),
            'taskTool': $('#task_tool')
        }),
